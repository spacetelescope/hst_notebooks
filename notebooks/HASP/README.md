...
|DataDiagnostic|How to examine the input spectra for the HASP co-add code and determine what was and was not included in the coadded data product output|[DataDiagnostic.ipynb](https://github.com/spacetelescope/hst_notebooks/blob/main/notebooks/HASP/DataDiagnostic/DataDiagnostics.ipynb)|[DataDiagnostic.html](https://spacetelescope.github.io/hst_notebooks/notebooks/HASP/DataDiagnostic/DataDiagnostics.html)|
